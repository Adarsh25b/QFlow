...
const Tags=()=>
{
   ...
   return (
    ...
    <p className="tags-p">A tag is a keyword or label that categorises ypur question with other</p>
    <p className="tags-p">Using the right tags ,akes it easier for others to find your answer and answer your question</p>
